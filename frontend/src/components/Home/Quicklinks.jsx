  ...
  return (
    <div className='flex gap-10 p-30 justify-center items-center bg-white'>
      <div data-aos='slide-up' className="fileReport h-[250px] w-[300px] bg-gray-100 p-10 flex flex-col gap-3 justify-center items-center group hover:bg-gray-200 shadow-2xl rounded-md duration-300">
        ...
        <button
          className="opacity-0 group-hover:opacity-100 justify-center w-[150px] items-center bg-white text-lime-700 p-2 rounded-lg hover:bg-lime-200 hover:scale-105 duration-400"
          onClick={() => isLoggedIn ? navigate('/onlinefir') : navigate('/login')}
        >
          File FIR
        </button>
      </div>
      ...
      <div data-aos='slide-up' className="fileReport h-[250px] w-[300px] bg-gray-100 p-10 flex flex-col gap-3 justify-center items-center group hover:bg-gray-200 shadow-2xl rounded-md duration-300">
        ...
        <button
          className="opacity-0 group-hover:opacity-100 justify-center w-[150px] items-center bg-white text-lime-700 p-2 rounded-lg hover:bg-lime-200 hover:scale-105 duration-400 z"
          onClick={() => isLoggedIn ? navigate('/recorder') : navigate('/login')}
        >
          Upload
        </button>
      </div>
      ...
      <div data-aos='slide-up' className="fileReport h-[250px] w-[300px] bg-gray-100 p-10 flex flex-col gap-3 justify-center items-center group hover:bg-gray-200 shadow-2xl rounded-md duration-300">
        ...
        <button
          className="opacity-0 group-hover:opacity-100 justify-center w-[150px] items-center bg-white text-lime-700 p-2 rounded-lg hover:bg-lime-200 hover:scale-105 duration-400"
          onClick={() => isLoggedIn ? navigate('/emergency') : navigate('/login')}
        >
          Contact
        </button>
      </div>
      ...
      <div data-aos='slide-up' className="fileReport h-[250px] w-[300px] bg-gray-100 p-10 flex flex-col gap-3 justify-center items-center group hover:bg-gray-200 shadow-2xl rounded-md duration-300 transition-all">
        ...
        <button
          className="opacity-0 group-hover:opacity-100 justify-center w-[150px] items-center bg-white text-lime-700 p-2 rounded-lg hover:bg-lime-200 hover:scale-105 duration-400 transition-all"
          onClick={() => isLoggedIn ? navigate('/safety') : navigate('/login')}
        >
          Discover
        </button>
      </div>
