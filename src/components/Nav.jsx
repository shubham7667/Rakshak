...
import FeatureDrop from './Dropdowns/features';
        ...
        <div >
            <nav className='bg-[#9ACD32] py-4 px-5 flex justify-around   items-center' >
                ...
                <ul className='list-none  flex gap-10  font-semibold  '>
                    <div onClick={handleOnclick} className="listItems relative text-zinc-600 px-5 py-3 hover:bg-[#B3DA65] hover:text-white rounded-xl trainsition-full duration-400 " > <li className=''><Link to='/features' className='flex justify-center items-center gap-2 '>Features < IoMdArrowDropdown /></Link> </li>
                    </div>
                ...
                <div className="btn flex gap-10">
                    ...
                    <button className='flex justify-center  items-center gap-5  px-5 py-3 text-white font-fine rounded-md bg-black hover:scale-105 duration-400 hover:cursor-pointer'>Sign Up <FaArrowRight /></button>

                </div>
            </nav>
            <div className="dropbody w-full  flex justify-center items-center">
                {isDisplay && <FeatureDrop />}
            </div>
